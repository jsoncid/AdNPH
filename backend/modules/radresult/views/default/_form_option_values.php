...
<div id="panel-option-values" class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-check-square-o"></i> Radiology Result</h3>
    </div>
    ...
    <table class="table table-bordered table-striped margin-b-none">
        ...
        <tr>
                ...
                <th class="required">Type of Radiology Result</th>
        ...
        <tbody class="form-options-body">
            <?php foreach ($modelsoption as $index => $modelOptionValue): ?>
                <tr class="form-options-item">
        			...
        			<td class="vcenter">
                        <?= $form->field($modelOptionValue, "[{$index}]name")->label(true)->textInput(['maxlength' => 128]); ?>
                    </td>
    				<td>
                       ...
                       <?= $form->field($modelOptionValue, "[{$index}]path")->label(false)->widget(FileInput::classname(), [
                            ...
                            'pluginOptions' => [
                                ...
                                'uploadUrl' => Url::to(['@webroot/upfiles/radioresult']),
                                'previewSettings' => [
