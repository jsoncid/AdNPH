 ...
 * @var backend\modules\labresult\models\OptionValueSearch $searchModel
...
<div class="pho-labresult-index">
    <div class="card">
       ...
       <!--     Html::a('Create Lab Result', ['create'], ['class' => 'btn btn-success']) ?> -->
       	<?php echo Html::button('Create Lab Result', ['value'=>Url::to('default/create'),'class' => 'btn btn-success', 'id' =>'modalButton']); 
