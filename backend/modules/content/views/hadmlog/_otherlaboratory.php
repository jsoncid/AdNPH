...
<tr  >
     <td ><h3>OTHER LABORATORY REQUEST</h3></td>
  </tr>
</table>
...
<table style="width:100% ;text-align: left; border: 0px solid black; border-collapse: collapse;">
	...
	<tr>
     <td style="border: 0px solid black; border-collapse: collapse;width:50%" >(&nbsp;&nbsp;&nbsp;) U/A</td>
     <td style="border: 0px solid black; border-collapse: collapse;" ></td>
  	</tr>
  		<tr>
     <td style="border: 0px solid black; border-collapse: collapse;width:50%" >(&nbsp;&nbsp;&nbsp;) S/E</td>
     <td style="border: 0px solid black; border-collapse: collapse;" ></td>
  	</tr>
  		<tr>
     <td style="border: 0px solid black; border-collapse: collapse;width:50%" >(&nbsp;&nbsp;&nbsp;) Sputum</td>
     <td style="border: 0px solid black; border-collapse: collapse;" ></td>
  	</tr>
  		<tr>
     <td style="border: 0px solid black; border-collapse: collapse;width:50%" >(&nbsp;&nbsp;&nbsp;) GEN Expert</td>
     <td style="border: 0px solid black; border-collapse: collapse;" ></td>
  	</tr>
  		<tr>
